...
class Record{
	...
	private static int myTankNums;
	private static int enemyTankNums;
    private static int deadEnemyTankNums;
    private static int deadmyTankNums;
     ...
     * @param myTankNums
     * @param enemyTankNums
     * @param deadEnemyTankNums
     */
    public static void setInfo(int myNums,int enemyNums){
    	
    	myTankNums = myNums;
    	enemyTankNums = enemyNums;
    }
    
    
    public static int getDeadmyTankNums() {
		return deadmyTankNums;
	}
    
    public static int getMyTankNums() {
		return myTankNums;
	}
	...
	public static int getDeadEnemyTankNums() {
		return deadEnemyTankNums;
	}
