...
class MyPanel extends JPanel implements KeyListener,Runnable,ActionListener{
	...
	public void showPlayerData(Graphics g){
	    ...
	    g.setFont(font);
	    g.drawString(Record.getEnemyTankNums()+"", 175, 475);
	    g.drawString(Record.getMyTankNums()+"", 375, 475);
	    
	    //显示右方玩家击杀数据
	    
	    font = new Font("宋体",Font.BOLD,50);
	    g.drawString("玩家1战绩", 500, 50);
	    g.drawString("击杀:"+Record.getDeadEnemyTankNums(), 500, 100);
	    g.drawString("死亡："+Record.getDeadmyTankNums(), 500, 150);
